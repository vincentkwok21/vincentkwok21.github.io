...
<sub> The Optimal and Suboptimal sequence of procedures. Apologies for the poor flowchart shape choices.</sub>
...
void nt1(int width, int start) {
 ...
 always at the front. I found that it was the overlap of Red passing green lights that caused the slow down. At this point I had finally narrowed the slow down to the buzzer or the sensor. Consulting the documentation of the sensor,
 I found people a
